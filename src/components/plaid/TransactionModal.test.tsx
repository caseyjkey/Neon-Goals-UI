...
describe('TransactionModal', () => {
  ...
  it('loads stored transactions and surfaces sync errors instead of showing an empty state', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText('Could not load stored transactions')).toBeInTheDocument();
    });
